#!/usr/bin/env python3
"""
build_v42.py  —  v10 design, all fixes -> v42.zip

Fixes over v41:
  1. /app page: replaced minimal scratch-built page with faithful full-design
     reproduction matching original app.html — hero + 9-feature grid +
     languages section + "Why Get Quran" + Arabic verse + download CTA.
...
OUT_ZIP  = os.path.expanduser('~/Downloads/getquran_cloudflare_deploy_v42.zip')
